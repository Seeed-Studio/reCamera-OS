...
struct morse_reg_rule ca_reg_rules[] = {
	/* S1G Actual Frequencies */
	_MRR(902, 904, 2, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(904, 912, 8, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(912, 920, 8, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(920, 928, 8, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),

	/* S1G->11ac Mapped Frequencies */
	_MRR(5650, 5690,  40, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
...
struct morse_reg_rule sg_reg_rules[] = {
	/* S1G Actual Frequencies */
	_MRR(866, 869, 2, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(920, 925, 4, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),

	/* S1G->11ac Mapped Frequencies */
	_MRR(5190, 5210, 20, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(5210, 5250, 40, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(5735, 5815, 80, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
	_MRR(5815, 5835, 20, 0, 30, AUTO_BW, 10000, 10000, false, 0, 0, 0),
};
