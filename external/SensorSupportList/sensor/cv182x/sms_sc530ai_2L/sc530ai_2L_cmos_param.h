#ifndef __SC530AI_2L_CMOS_PARAM_H_
#define __SC530AI_2L_CMOS_PARAM_H_
...
static const sc530AI_2L_MODE_S g_astsc530AI_2L_mode[sc530AI_2L_MODE_NUM] = {
	[sc530AI_2L_MODE_1620P30] = {
		.name = "1620p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 2880,
...
struct combo_dev_attr_s sc530ai_2l_rx_attr = {
...
#endif /* __sc530AI_2L_CMOS_PARAM_H_ */
